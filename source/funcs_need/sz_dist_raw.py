...
def process_file (in_path):
    ...
    if (n_seizures > 5):
        ...
        seizure_time_dist.__setitem__('time_dist', values_seizures.copy())
        # save the seizure distance matrix as a mat file
        sio.savemat(os.path.join(out_subfolder, "seizure_time_dist_{}.mat".format(id_patient)), seizure_time_dist)
        ...
        # Save the Seizure distance matrix as a mat file
        sio.savemat ( os.path.join ( out_subfolder, "seizure_dist_eucl_{}.mat".format ( id_patient ) ), seizure_dist_mEucl )
    return True
